...
!	USE IMSLF90
	integer i,j
	real m,n,mn,Rx,Ry,Rs,Theta,Dangle,Relx,Rely,Rels,Ax,Ay,As,Bx,By,Bs
	real Rav,Rratio,Relav,Reliability,X,Y,S,SNP,ThirdSN,At,Bt,Tm,Tnc,Tmn
	real PI
	...
	READ(100,*) SNmodel
	READ(100,*) Dangle,ThirdSN !If the SN curve was not the shear stre
	CLOSE(UNIT=100)
	
	PI=3.14159265
	Theta=(Dangle/180)*PI
	Tempangle=(ThirdSN/180)*PI
