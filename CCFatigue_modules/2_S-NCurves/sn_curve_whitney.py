...
if __name__ == "__main__":
    ...
    avg_stress = (
        agg_df[["stress_ratio_id", "stress_level_id", "stress_parameter"]]
    ...
    stress_ratios_df["log10_number_of_cycles"] = (
        agg_df[["stress_ratio_id", "log10_number_of_cycles"]]
    ...
    # Eq 9
    # LSSE
    agg_df["lsse"] = (agg_df.log10_number_of_cycles - agg_df.ycar) ** 2
    ...
    # Q
    stress_ratios_df["xb"] = (
        agg_df[["stress_ratio_id", "log10_stress_parameter"]]
        .groupby("stress_ratio_id")
        .mean()
    )
