  ...
  created() {
    ...
    this.unsubscribe = this.$store.subscribe(mutation => {
      if (mutation.type === 'saveTest') {
        Bokeh.embed.embed_item(this.test.plot.stress_strain, this.id.bokeh.stressStrain)
        Bokeh.embed.embed_item(this.test.plot.creep, this.id.bokeh.creep)
        Bokeh.embed.embed_item(this.test.plot.hysteresis_area, this.id.bokeh.hysteresisArea)
        Bokeh.embed.embed_item(this.test.plot.stiffness, this.id.bokeh.stiffness)
      }
    });
  },
  beforeDestroy() {
