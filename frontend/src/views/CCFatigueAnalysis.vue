      ...
      <v-col cols="6">
        <v-card :loading="snCurve.loading">
          <v-card-title>
            ...
            <v-spacer />
            <info-tooltip>
              This module plots curves on the (Stress - Number of cycles) plane. The curves are associated with 4 different methods (Lin-Log, Log-Log, Sendeckyj, Whitney) and can be considered as constitutive laws for fatigue life predictions. On the graphs we also plot the individual results gathered over the tests with inputs (Cycles to failure - Stress at failure)
            </info-tooltip>
          </v-card-title>
          <v-card-subtitle>
            <v-container>
          ...
          <v-card-title>
            ...
            <info-button>
              <template v-slot:title>
                ...
                The Constant Life Diagram (CLD) allows us to predict the outcome of tests for different values of stress ratio (R). The results are represented in a Mean Stress - Stress Amplitude plane and define what is considered to be the safe use region.
            </info-button>
          </v-card-title>
          <v-container fluid>
            <v-row class="mx-2">
              ...
              <info-button>
                ...
                The data required as input is a csv file with 3 distinct columns:
                <ul>
                  <li>Stress ratio (R) [-]</li>
                  <li>Number of cycles to failure</li>
                  <li>Stress parameter (Stress at failure) [MPa]</li>
                </ul>
                Additionally to these 3 columns, there are 11 values required for analysis:
                <ul>
                  <li>R-ratio</li>
        ...
        <v-card>
          <v-card-title>
            ...
            <info-button>
              ...
              The fatigue failure module allows us to predict the S-N curve that will arise from off axis loadings. It is designed for experiments where samples are subjected to multiaxial loadings.
            </info-button>
          </v-card-title>
          <v-container fluid>
            <v-row class="mx-2">
              ...
              <info-button>
                ...
                <p>
                  The data type selection box allows us to enter static, fatigue and reference data that are necessary to the analysis, the values that should be placed as input are dependent on the method used for analysis. Static data have to do with the static parameters of an experiment, they give information relative to the strength of the material. Fatigue data are related to the fatigue analysis, they give information about the fatigue life of the experiment. Reference data are related to the data we wish to extract from the analysis, they give information about the orientation in which we seek more information.
                </p>
                <p>
                  The inputs to provide highly depend on the selected method but there are two main formats used as input data:
                </p>
                <p>
                ...
                <p>
                  Fawaz-Ellyin, FTPF, Hashim-Rothem, Sims-Brogdon: (Same as output of S-N curve module)
                  <ul>
                    <li>Stress ratio (R) [-]</li>
                    <li>Number of cycles to failure</li>
                    <li>Stress parameter (Stress at failure) [MPa]</li>
        ...
        <v-card>
          <v-card-title>
            ...
            <info-button>
              ...
              The damage summation module is based on the Palgrem-Miner linear damage rule; it allows us to define failure in a numerical fashion. This method is particularly interesting when dealing with varying amplitude loading, as it can be tedious to keep track of the damage inflicted on the sample for each loading/unloading cycle.
            </info-button>
          </v-card-title>
          <v-container fluid>
            <v-row class="mx-2">
              ...
              <info-button>
                ...
                The data used as input for this method is slightly different than that of the previous modules. As damage summation deals with the fatigue life as a whole, we use the results from the previous analysis. We first browse for the load spectrum which is presented as a txt file with one numerical column representing the peaks and valleys of the loading. We then select the method we will use for counting the cycles, and finally choose the appropriate methods for CLD and for S-N curves/fatigue failure depending on whether we are in presence of a uniaxial or multiaxial loading.
              </info-button>
            </v-row>
            <v-row justify="end">
              <v-btn class="ma-5">Run</v-btn>
...
export default {
  ...
  data () {
    return {
      ...
      fatigueFailureMethods: [
        'Fawaz-Ellyin',
        'Kawai',
        'ST'
      ],
      dammageSummationMethods: [
        'Linear',
        'Piecewise-Linear'
      ],
      id: {
