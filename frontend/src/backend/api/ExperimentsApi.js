...
export default class ExperimentsApi {
   ...
   */
  postDataPreprocessCheckV2WithHttpInfo(file) {
    let postBody = null;
    // verify the required parameter 'file' is set
    if (file === undefined || file === null) {
      throw new Error(
        "Missing the required parameter 'file' when calling postDataPreprocessCheckV2"
      );
    }
   ...
   */
  postDataPreprocessCheckV2(file) {
    return this.postDataPreprocessCheckV2WithHttpInfo(file).then(function (
      response_and_data
    ) {
      return response_and_data.data;
    });
