...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('fracture_mode',
                  sa.Enum('Mode I', 'Mode II', 'Mode III', 'Combined', '',
                          name='fracture_mode'),
                  nullable=True),
        sa.Column('initial_crack_length', sa.Float(), nullable=True),
        sa.Column('fatigue_test_type',
                  sa.Enum('CA', 'VA', 'BL', 'Combined', '',
        ...
        sa.Column('control_mode',
                  sa.Enum('Load Controlled', 'Displacement Controlled', '',
                          name='control_mode'),
                  nullable=True),
